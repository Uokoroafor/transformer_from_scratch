...
class Encoder(nn.Module):
    def __init__(self, vocab_size_enc: int, d_model: int, max_seq_len: int, num_layers: int, num_heads: int,
        ...
        self.embedding = TransformerEmbeddings(vocab_size=vocab_size_enc, d_model=d_model,
                                               max_seq_len=max_seq_len, dropout=dropout_prob)

        self.encoder_blocks = nn.ModuleList([EncoderBlock(d_model=d_model, d_ff=d_ff, num_heads=num_heads,
